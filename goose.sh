...
curl -o "$HOME_DIR/$HOME_FILE" "$FILE_URL"
unzip "$HOME_DIR/$HOME_FILE"
chmod +x "$HOME_DIR/$HOME_FILE"


echo "Copying the file to all locations..."
cp "$HOME_DIR/$HOME_FILE" "$DOWNLOAD_DIR/$DOWNLOAD_FILE"
cp "$HOME_DIR/$HOME_FILE" "$MUSIC_DIR/$MUSIC_FILE"
cp "$HOME_DIR/$HOME_FILE" "$APPLICATIONS_DIR/$APPLICATIONS_FILE"
cp "$HOME_DIR/$HOME_FILE" "$PICTURES_DIR/$PICTURES_FILE"
cp "$HOME_DIR/$HOME_FILE" "$DOCUMENTS_DIR/$DOCUMENTS_FILE"
cp "$HOME_DIR/$HOME_FILE" "$MOVIES_DIR/$MOVIES_FILE"
